...
export default function Home() {
    ...
    const handleAnimationEnd = () => {
      const elem = document.querySelector(`.${styles.roles_text}`);
      elem?.classList.remove(styles.fadeIn);
    };
    ...
    useEffect(() => {
      ...
      const loop = async () => {
        ...
        elem?.classList.add(styles.fadeIn);
        await fetchData();
        setText("I do research on behavioral finance & fintech.");
        elem?.classList.add(styles.fadeIn);
        await fetchData();
      ...
      <main className={styles.main}>
        ...
        <div className={styles.roles}>
          <div className={styles.roles_container}>
              <span className={styles.roles_brackets}>[</span>      
              <span onAnimationEnd={handleAnimationEnd} className={styles.roles_text}>{text}</span>
              <span className={styles.roles_brackets}>]</span>
          </div>
        </div>
